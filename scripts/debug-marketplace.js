...
async function main() {
  ...
  const nsAddress = process.env.NEXT_PUBLIC_CREDIT_CONTRACT_ADDRESS;
  ...
  console.log("CreditNameService:", nsAddress);
  console.log("CreditNameMarketplace:", mktAddress);

  // Get contract instances
  const ns = await ethers.getContractAt("CreditNameService", nsAddress);
