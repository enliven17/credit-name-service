...
export class CreditNameMarketplaceContract {
  ...
  async list(name: string, priceWei: bigint): Promise<string> {
    ...
    console.log(`Listing fee required: ${ethers.formatEther(listingFee)} CTC`)
    ...
    console.log(`Price: ${ethers.formatEther(priceWei)} CTC`)
    console.log(`Fee: ${ethers.formatEther(listingFee)} CTC`)
...
export const getMarketplaceContract = (provider: any) => new CreditNameMarketplaceContract(provider)
